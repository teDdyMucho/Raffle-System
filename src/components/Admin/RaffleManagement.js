  ...
  return (
    <div className="space-y-6">
      ...
      <div className="flex justify-between items-center">
        <div>
          <h1 className="text-3xl font-bold text-gray-900 dark:text-white mb-2">Raffle Management</h1>
          <p className="text-gray-600 dark:text-gray-400">Create and manage your raffle campaigns</p>
        </div>
        <button
            ...
            <div className="flex justify-between items-start mb-6">
              <div>
                ...
                <div className="flex items-center space-x-3">
                  <span className={`px-3 py-1 rounded-full text-xs font-semibold flex items-center shadow-sm ${getStatusColor(raffle.status)}`}>
                    {getStatusIcon(raffle.status)}
                    <span className="ml-2">{raffle.status.charAt(0).toUpperCase() + raffle.status.slice(1)}</span>
                  </span>
                  <span className="text-sm text-gray-600 dark:text-gray-400 bg-gray-100 dark:bg-gray-700 px-2 py-1 rounded-md">{raffle.category}</span>
                </div>
              </div>
            </div>
      ...
      {showCreateModal && (
        <div className="fixed inset-0 bg-black bg-opacity-50 flex items-center justify-center p-4 z-50">
          <div className="bg-white dark:bg-gray-800 rounded-lg p-6 w-full max-w-2xl max-h-[90vh] overflow-y-auto">
            <h3 className="text-xl font-bold text-gray-900 dark:text-white mb-6">Create New Raffle</h3>
            ...
            <div className="space-y-4">
              ...
              <div>
                ...
                />
                <p className="mt-1 text-xs text-gray-500 dark:text-gray-400">Upload an image of the prize (PNG/JPG).</p>
